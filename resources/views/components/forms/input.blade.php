...
<div class="w-full">
    ...
    <input
        ...
        {{ $attributes->merge([
            'class' => 'w-full px-4 py-2.5 bg-surface2 dark:bg-surface-900 border rounded-lg text-text-900 dark:text-text-200 placeholder:text-text-400 dark:placeholder:text-text-500 focus:outline-none focus:ring-2 transition-colors ' .
